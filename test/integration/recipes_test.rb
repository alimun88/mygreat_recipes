...
class RecipesTest < ActionDispatch::IntegrationTest
    ...
    def setup
      @chef = Chef.create!(chef_name: "mohammad1", email: "mohammad1@example.com",
    ...
    test "create new valid recipe" do
      ...
      ingredients_of_recipe = "chicken 3pc, vegetable 2 kind"
      description_of_recipe = "add chicken, add vegetables, cook for 20 minutes, serve delicious meal"
      assert_difference 'Recipe.count', 1 do
        post recipes_path, params: { recipe: { name: name_of_recipe, ingedients: ingredients_of_recipe, 
